...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-08-2023 a las 01:06:29
...
-- Base de datos: `argo`
--
CREATE DATABASE IF NOT EXISTS `argo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `argo`;
...
CREATE TABLE `proveedor` (
  ...
  `provemail` varchar(255) DEFAULT NULL,
  `provname` varchar(255) DEFAULT NULL,
  `provpassword` varchar(255) DEFAULT NULL,
  `provnic` varchar(15) DEFAULT NULL,
  `provtel` varchar(15) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 'argo@argo.com', 'argo', '123', '498484', '565656', 1),
(2, 'nestle@nestle.com', 'nestle', '126', '498484', '5656566', 1);
...
(3, 'bra@gmail.com', 'tova tova', '123', 'adssdad', '1515', '5959-09-05', '0712695985'),
(6, 'gt@gt.com', 'brandon Garcia Gonzalez', '12345', 'Cda de la manzana 35 SAN JOSE BUENAVISTA', '151515', '2525-10-25', '0707070707');
...
(9, '3', 'argo', '2023-08-09', '03:15:00', 15),
(10, '2', 'Palett de chocolate', '2023-10-18', '13:50:00', 10),
(13, '2', 'jijijij', '2023-08-10', '13:26:00', 100),
(12, '3', 'argo', '2023-09-08', '13:31:00', 15),
(15, '2', 'chocolate', '2023-10-10', '13:50:00', 150),
(16, '2', 'chocolate', '2023-12-15', '15:50:00', 15),
(19, '3', 'argo', '2023-08-16', '13:50:00', 15);
...
('root', '[{\"db\":\"edoc\",\"table\":\"patient\"},{\"db\":\"edoc\",\"table\":\"doctor\"},{\"db\":\"edoc\",\"table\":\"admin\"},{\"db\":\"edoc\",\"table\":\"webuser\"},{\"db\":\"edoc\",\"table\":\"schedule\"}]');
...
('root', '2023-08-15 19:33:06', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\",\"NavigationWidth\":0}');
...
-- Base de datos: `yibun`
--
CREATE DATABASE IF NOT EXISTS `yibun` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `yibun`;
...
(1, 'admin', '', '', '', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', 1, 1, '2023-08-11 13:00:28');
