    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-homo-iceblue">
     ...
     <!--       <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="" class="non-style-link-menu"><div><p class="menu-text">OPCION 4</p></a></div>
                    </td>
                </tr>-->
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-user">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Busca al proveedor por nombre o email" list="doctors">&nbsp;&nbsp;
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                         ...
                         <!--       <td>
                                    <p style="padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                        Proximas entregas <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                    Aquí hay acceso rápido a las próximas citas (hasta 7 días) <br>
                                ...
                                <td>
                                    ...
                                    Aquí hay acceso rápido a las próximas sesiones que programaron hasta 7 días<br>
              ...
              <!--              <tr>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select appointment.appoid,schedule.scheduleid,schedule.title,doctor.docname,patient.pname,schedule.scheduledate,schedule.scheduletime,appointment.apponum,appointment.appodate from schedule inner join appointment on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid  where schedule.scheduledate>='$today'  and schedule.scheduledate<='$nextweek' order by schedule.scheduledate desc";
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br>
                                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No hemos podido encontrar nada relacionado con tus palabras clave !</p>
                            ...
                            <!--    <td>
                                ...
                                <td>
                                    <center>
                                        <a href="schedule.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Ver todas las sesiones</button></a>
                                    </center>
                                </td>
                            </tr>
                        </table>
