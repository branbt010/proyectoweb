        ...
        <table border="0" style="width: 69%;">
            <tr>
                <td colspan="2">
                    ...
                    <p class="sub-text">Todo listo, Crea una nueva cuenta de usuario ahora.</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <label for="tele" class="form-label">Numero telefonico: </label>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <label for="newpassword" class="form-label">Crear una nueva contraseña </label>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <br>
                    <label for="" class="sub-text" style="font-weight: 280;"> ¿Tienes una cuenta? </label>
