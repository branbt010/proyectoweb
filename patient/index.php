            ...
            <table class="menu-container" border="0">
              ...
              <!--  <tr class="menu-row" >
                    <td class="menu-btn menu-icon-home menu-active menu-icon-home-active" >
                        <a href="index.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">option 1</p></a></div></a>
                    </td>
                </tr> -->
                <tr class="menu-row">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-settings">
                        <a href="settings.php" class="non-style-link-menu"><div><p class="menu-text">OPCION 5</p></a></div>
                    </td>
                </tr>
-->
            </table>
